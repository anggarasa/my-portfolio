                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-lg text-muted-foreground">
                                                Add a new project to showcase in
                                                your portfolio
                                            </p>
                                        </div>
                                    </div>
                    ...
                    >
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    List all technologies and tools used in this
                                    project
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Add links to your GitHub repository and live
                                    demo
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Add demo accounts for testing your project
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Add a testimonial from your client or team
                                    member
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
