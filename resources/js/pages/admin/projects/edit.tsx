                        ...
                        >
                            ...
                            <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                                <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                    ...
                                    <CardDescription>
                                        Update technologies and tools used in
                                        this project
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6 p-6">
                            ...
                            <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                                <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                    ...
                                    <CardDescription>
                                        Update links to your GitHub repository
                                        and live demo
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6 p-6">
                            ...
                            <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                                <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                    ...
                                    <CardDescription>
                                        Update testimonial from your client or
                                        team member
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6 p-6">
