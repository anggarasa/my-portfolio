                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-lg text-muted-foreground">
                                                Update and modify your project
                                                information
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-sm text-muted-foreground">
                                            Make your changes and save to update
                                        </div>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Update images and visual assets for your
                                    project
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Update technologies and tools used in this
                                    project
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Update links to your GitHub repository and
                                    live demo
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Update challenges, solutions, and key
                                    features
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Manage demo accounts for testing your
                                    project
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            value={newDemoAccount.description}
                                            onChange={(e) =>
                                                setNewDemoAccount({
                                                    ...newDemoAccount,
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Update testimonial from your client or team
                                    member
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
                        ...
                        <Card className="border-0 bg-background/80 shadow-lg backdrop-blur-sm">
                            <CardHeader className="border-b border-border/50 bg-gradient-to-r from-muted/30 to-muted/10">
                                ...
                                <CardDescription>
                                    Configure project visibility and ordering
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 p-6">
